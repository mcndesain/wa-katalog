function pagination(a) {
    var e = "";
    leftnum = parseInt(numshowpage / 2), leftnum == numshowpage - leftnum && (numshowpage = 2 * leftnum + 1), start = postnumber - leftnum, start < 1 && (start = 1), maximum = parseInt(a / postperpage) + 1, maximum - 1 == a / postperpage && (maximum -= 1), end = start + numshowpage - 1, end > maximum && (end = maximum), e += "<span class='totalpages'>Halaman " + postnumber + " dari " + maximum + "</span>";
    var s = parseInt(postnumber) - 1;
    postnumber > 1 && (e += 2 == postnumber ? "page" == type ? '<span class="showpage"><a class="external" href="' + home_page + '">' + "<i class="fas fa-arrow-left"></i>" + "</a></span>" : '<span class="pagenumber"><a class="external" href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">' + "<i class="fas fa-arrow-left"></i>" + "</a></span>" : "page" == type ? '<span class="pagenumber"><a class="external" href="#" onclick="redirectpage(' + s + ');return false">' + prevpage + "</a></span>" : '<span class="pagenumber"><a class="external" href="#" onclick="redirectlabel(' + s + ');return false">' + prevpage + "</a></span>"), start > 1 && (e += "page" == type ? '<span class="pagenumber"><a class="external" href="' + home_page + '">1</a></span>' : '<span class="pagenumber"><a class="external" href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">1</a></span>'), start > 2 && (e += "");
    for (var r = start; r <= end; r++) e += postnumber == r ? '<span class="current">' + r + "</span>" : 1 == r ? "page" == type ? '<span class="pagenumber"><a class="external"  href="' + home_page + '">1</a></span>' : '<span class="pagenumber"><a class="external" href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">1</a></span>' : "page" == type ? '<span class="pagenumber"><a class="external" href="#" onclick="redirectpage(' + r + ');return false">' + r + "</a></span>" : '<span class="pagenumber"><a class="external" href="#" onclick="redirectlabel(' + r + ');return false">' + r + "</a></span>";
    end < maximum - 1 && (e += ""), end < maximum && (e += "page" == type ? '<span class="pagenumber"><a class="external" href="#" onclick="redirectpage(' + maximum + ');return false">' + maximum + "</a></span>" : '<span class="pagenumber"><a class="external" href="#" onclick="redirectlabel(' + maximum + ');return false">' + maximum + "</a></span>");
    var n = parseInt(postnumber) + 1;
    postnumber < maximum && (e += "page" == type ? '<span class="pagenumber"><a class="external" href="#" onclick="redirectpage(' + n + ');return false">' + "<i class="fas fa-arrow-right"></i>" + "</a></span>" : '<span class="pagenumber"><a class="external" href="#" onclick="redirectlabel(' + n + ');return false">' + "<i class="fas fa-arrow-right"></i>" + "</a></span>");
