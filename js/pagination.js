function pagination(a) {
    ...
    postnumber > 1 && (e += 2 == postnumber ? "page" == type ? '<span class="showpage"><a class="external" href="' + home_page + '">' + prevpage + "</a></span>" : '<span class="pagenumber"><a class="external" href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">' + prevpage + "</a></span>" : "page" == type ? '<span class="pagenumber"><a class="external" href="#" onclick="redirectpage(' + s + ');return false">' + prevpage + "</a></span>" : '<span class="pagenumber"><a class="external" href="#" onclick="redirectlabel(' + s + ');return false">' + prevpage + "</a></span>"), start > 1 && (e += "page" == type ? '<span class="pagenumber"><a class="external" href="' + home_page + '">1</a></span>' : '<span class="pagenumber"><a class="external" href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">1</a></span>'), start > 2 && (e += "");
    ...
    postnumber < maximum && (e += "page" == type ? '<span class="pagenumber"><a class="external" href="#" onclick="redirectpage(' + n + ');return false">' + nextpage + "</a></span>" : '<span class="pagenumber"><a class="external" href="#" onclick="redirectlabel(' + n + ');return false">' + nextpage + "</a></span>");
